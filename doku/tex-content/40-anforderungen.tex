...
%TO-DO: Grafik Projektskizze sollte erst im Teil "Herangehensweise" gezeigt und erläutert werden; vorgreifende Referenz im Text abändern?
\begin{figure}[H]N
    \centering
    \caption{Projektsizee aus Projektbesprechung vom 27.11.2021, Teil 1}
    \label{fig:2021-11-27-projektskizze-1}
    \fbox{\includegraphics[width=0.7\textwidth]{2021-11-27-projektskizze-1}}
\end{figure}
...
\begin{figure}[H]
    ...
    \fbox{\includegraphics[width=0.7\textwidth]{2021-11-27-projektskizze-2}}
\end{figure}
