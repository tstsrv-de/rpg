...
Zu den \textbf{Websockets} wurde im Kapitel \nameref{anforderungen} einige Grundlagen erklärt. Bei der Entwicklung wurde hier als erster Programteil nach den Basisfunktionen eine Chat-Funktion über die Websockets implementiert. 
